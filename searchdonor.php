                ...
                <div class="row">
                    <div class="col-lg-14">
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-12 p-0">
                                <button type="submit" class="btn btn-primary wrn-btn" name="subsearch" style="border-color: #669BBC; background: #669BBC; padding: 5px;">Search</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="h-100 w-25">
                <div class="card h-100">
                    ...
                    <div class="card-footer">
                        <a href="tel:<?php echo $mob; ?>" class="btn btn-primary">Contact</a>
                    </div>
                </div>
            </div>
